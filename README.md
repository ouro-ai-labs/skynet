...
> **Supported agent types**: Currently only **Claude Code** (`claude-code`) is supported. Other types (`codex-cli`, `gemini-cli`, `opencode`, `generic`) are not yet supported and will be added in future releases.
